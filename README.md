...
```
ghcr.io/jobrunner/spatialite-base-image:alpine-3.0.1
ghcr.io/jobrunner/spatialite-base-image:ubuntu-3.0.1
ghcr.io/jobrunner/spatialite-base-image:3.0.1          # Alpine (default)
```
...
ghcr.io/jobrunner/spatialite-base-image:ubuntu-dev-3.0.1
ghcr.io/jobrunner/spatialite-base-image:dev-3.0.1       # Alpine (default)
```
...
```bash
docker run --user root -it ghcr.io/jobrunner/spatialite-base-image:alpine-dev-3.0.1 sh
```
...
docker run --rm -it \
  -v $(pwd)/data:/data \
  ghcr.io/jobrunner/spatialite-base-image:3.0.1 \
...
```dockerfile
# Build stage
FROM ghcr.io/jobrunner/spatialite-base-image:ubuntu-dev-3.0.1 AS builder
...
FROM ghcr.io/jobrunner/spatialite-base-image:ubuntu-3.0.1
